...
class FormsApi(object):
    ...
    def get_all_forms(self, **kwargs):  # noqa: E501
        """Get all forms  # noqa: E501

        Returns all forms  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_forms(async_req=True)
        >>> result = thread.get()
        ...
        :param str order_by: Reference attribute to order forms
        :param str language: Language of the form
        :param int list_id: ID of the list that owns the form
        :param int owner: User ID of the form owner
        ...
        return self.get_all_forms_with_http_info(**kwargs)  # noqa: E501

    def get_all_forms_with_http_info(self, **kwargs):  # noqa: E501
        """Get all forms  # noqa: E501

        Returns all forms  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_forms_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(FormCollection, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['offset', 'limit', 'order', 'order_by', 'language', 'list_id', 'owner', 'status', 'created_min', 'created_max', 'updated_min', 'updated_max']  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_all_forms" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']

        if self.api_client.client_side_validation and 'offset' in local_var_params and local_var_params['offset'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `offset` when calling `get_all_forms`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 100:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_all_forms`, must be a value less than or equal to `100`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_all_forms`, must be a value greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'list_id' in local_var_params and local_var_params['list_id'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `list_id` when calling `get_all_forms`, must be a value greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'owner' in local_var_params and local_var_params['owner'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `owner` when calling `get_all_forms`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            response_type='FormCollection',  # noqa: E501
